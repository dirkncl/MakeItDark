...
var FrameCount = {
	...
	update: function() {
		...
		if (div) {
			var html =`
			  <table>
			    <tr><td align="right"><b>Current FPS:</b></td><td align="left">${this.current}</td></tr>
			    <tr><td align="right"><b>Average FPS:</b></td><td align="left">${this.average}</td></tr>
			    <tr><td align="right"><b>Total Frames:</b></td><td align="left">${this.totalFrames}</td></tr>
			  </table>
			
			  <br/><a href="#" onClick="FrameCount.reset()">Reset</a>
      `;
	...
	_now_epoch: function() {//result in second
