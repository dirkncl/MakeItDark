...
Palette.PRECISION       = 100;
Palette.USE_BLEND_SHIFT = 1;
Palette.CYCLE_SPEED     = 280;
Palette.ENABLE_CYCLING  = 1;
    
// this utility function allows for variable precision floating point modulus
Palette.DFLOAT_MOD = function(a,b) {
  return (Math.floor(a*Palette.PRECISION) % Math.floor(b*Palette.PRECISION))/Palette.PRECISION;
};

  
Palette.prototype.importColors = function (source) {
...
Palette.prototype.copyColors = function (source, dest) {
...
Palette.prototype.swapColors = function(a, b) {
...
Palette.prototype.reverseColors = function(colors, range) {
...
Palette.prototype.fadeColor = function(sourceColor, destColor, frame, max) {
...
Palette.prototype.shiftColors =function(colors, range, amount) {
...
Palette.prototype.blendShiftColors = function(colors, range, amount) {
...
Palette.prototype.cycle = function(sourceColors, timeNow, speedAdjust, blendShift) {
...
Palette.prototype.fade = function(destPalette, frame, max) {
...
Palette.prototype.fadeToColor = function(color, frame, max) {
...
Palette.prototype.burnOut = function (frame, max) {
...
Palette.prototype.getRawTransformedColors = function() {
